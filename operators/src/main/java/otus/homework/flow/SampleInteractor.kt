...
class SampleInteractor(private val sampleRepository: SampleRepository) {
     ...
     * Если айтемы в одном из флоу кончились то результирующий флоу также должен закончится.
     */
     ...
     *
     * При любом исходе, будь то выброс исключения или успешная отработка функции вызовите
     * метод sampleRepository.completed().
     */
    fun task4(): Flow<Int> {
        return sampleRepository.produceNumbers()
